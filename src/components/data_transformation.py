...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        '''
        This function will get the numerical and categorical columns and perform the data transformation 
    ...
    def initiate_data_transformation(self,train_path:str,test_path:str)-> tuple:
        ''' 
        This function will read the train and test dataframe, preprocess them and return the 
        train array, test array and the file path to the preprocessing object in a tuple.
        '''
        try:
            ...
            logging.info(f'Applying the preprocessing object on the training dataframe and testing dataframe.')
